...
- [ ] T004 [P] Setup Vue routing and state baseline (`vue-router`, `pinia`) in frontend/src/
- [ ] T005 [P] Setup unit/component test stack (`vitest`, `@vue/test-utils`) and test script
- [ ] T006 [P] Setup type-check/lint/format scripts (`vue-tsc`, `eslint`, `prettier`)
- [ ] T007 [P] Setup API mocking strategy for tests (e.g., `msw`)
- [ ] T008 [P] Setup E2E framework (`playwright` or `cypress`) for critical flows
...
- [ ] TXXX Add loading/empty/error/timeout/permission-denied UI states where applicable
- [ ] TXXX [P] Add frontend observability (analytics and/or error tracking) for key flows
- [ ] TXXX Accessibility pass for new/changed UI (keyboard, labels, contrast)
